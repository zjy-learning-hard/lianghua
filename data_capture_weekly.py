...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        file_name = r"C:\Users\17317\Desktop\lianghua\yili\trade_data\sh600887_trade"+data_dt+'.csv'
    ...
    stock_zh_a_hist_min_em_df.to_csv(r"C:\Users\17317\Desktop\lianghua\yili\minute_data\sh600887_"+today.strftime("%Y-%m-%d")+".csv", index=False)
    ...
    for i in range(5):
        ...
        file_name = r"C:\Users\17317\Desktop\lianghua\maotai\trade_data\sh600519_trade"+data_dt+'.csv'
        stock_intraday_sina_df.to_csv(file_name, index=False)
        print("CSV 文件保存成功！")
        time.sleep(60)
    stock_zh_a_hist_min_em_df = ak.stock_zh_a_hist_min_em(symbol="600519", start_date=start_dt, end_date=end_dt, period="1", adjust="")        
    stock_zh_a_hist_min_em_df.to_csv(r"C:\Users\17317\Desktop\lianghua\yili\minute_data\sh600519_"+today.strftime("%Y-%m-%d")+".csv", index=False)
              
        
        '''纳斯达克'''
    fund_etf_hist_min_em_df = ak.fund_etf_hist_min_em(symbol="513300", period="1", adjust="", start_date=start_dt, end_date=end_dt)
    fund_etf_hist_min_em_df.to_csv(r"C:\Users\17317\Desktop\lianghua\nasidake\minute_data\nasidake_"+today.strftime("%Y-%m-%d")+".csv", index=False)

        '''黄金etf'''
    fund_etf_hist_min_em_df = ak.fund_etf_hist_min_em(symbol="518880", period="1", adjust="", start_date=start_dt, end_date=end_dt)
    fund_etf_hist_min_em_df.to_csv(r"C:\Users\17317\Desktop\lianghua\gold\minute_data\gold_"+today.strftime("%Y-%m-%d")+".csv", index=False)
